...
<td><div style="padding-left: 20px">Dubious syllables: <input type="radio" name="dubious" value="process"@{[ $leave_dubious ? '' : 'checked' ]}>Try to process &nbsp; <input type="radio" name="dubious" value="leave" @{[ $leave_dubious ? 'checked' : '' ]} >Leave untranslated
</div>
</td>
</tr></table>
</div>
...
<div class="after">
<br><br>
&bull; This conversion code is Free Software; you can <a href="/tibetan/Lingua-BO-Wylie-dev.zip">download the Perl module here</a>, and <a href="/tibetan/JavaWylie-dev.zip">equivalent Java code here</a>.
